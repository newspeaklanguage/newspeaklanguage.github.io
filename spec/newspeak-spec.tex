...
Metadata appears in nestable comments of the form \code{ (*:id: xyz *)} where \code{id} is the name of a particular metadata interpreter that is intended to parse and process the text \code{xyz}. A metadata comment can appear between any two expressions or declarations.  
