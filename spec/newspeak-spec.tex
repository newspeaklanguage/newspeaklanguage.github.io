...
it defaults to \code{Object}.  
 ...
 \begin{newspeak}
 classDecl = ((tokenFromSymbol: \#class), identifier, typeParameterDecl opt, messagePattern, equalSign,
                     inheritanceListAndOrBody) $|$
                  ((tokenFromSymbol: \#class), identifier, typeParameterDecl opt, empty, equalSign,
                     inheritanceListAndOrBody).
typeParameterDecl = langleBracket, lbracket, identifier, (comma, identifier) star, rbracket, rangleBracket.
