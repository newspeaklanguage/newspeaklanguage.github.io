...
\title{Newspeak Programming Language Draft Specification Version 0.097}
\author{Gilad Bracha}
\begin{document}
\maketitle
\tableofcontents
...
A transient slot declaration has the form \code{transient $m ::= e.$} or \code{transient $m = e.$}, possinly prefixed with an access modifier.
